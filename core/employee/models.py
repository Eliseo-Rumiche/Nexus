...
class Worker(models.Model):
    ...
    birth_date = models.DateField(
        "Fecha Nacimiento", auto_now=False, auto_now_add=False
    )
    ...
    position = models.ForeignKey(
        Position, verbose_name="Cargo", on_delete=models.PROTECT
    )
    facebook_url = models.URLField(
        "Facebook Url", max_length=200, null=True, blank=True
    )
    instagram_url = models.URLField(
        "Instagram Url", max_length=200, null=True, blank=True
    )
